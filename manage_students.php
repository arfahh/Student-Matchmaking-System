...
$sql_students = "SELECT sid, firstName, lastName, program, username, password, email, year, resume_path, linkedin_link, github_link, website_link, other_links FROM students";
...
<body>
    ...
    <a href="add_student.php?adid=0" class="add-student-btn">Add New Student</a>
   ...
   <div class="table-container">
    <table border="1">
        ...
        <tbody>
            ...
            <td>
                    <a href="edit_student.php?adid=0&sid=<?php echo $student['sid']; ?>" class="edit-btn">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="delete_student.php?adid=0&sid=<?php echo $student['sid']; ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this student?')">
                ...
                <td><?php echo htmlspecialchars($student['Resume Path']); ?></td>
                <td><?php echo htmlspecialchars($student['linkedin_link']); ?></td>
                <td><?php echo htmlspecialchars($student['github_link']); ?></td>
                <td><?php echo htmlspecialchars($student['website_link']); ?></td>
                <td><?php echo htmlspecialchars($student['other_links']); ?></td>
